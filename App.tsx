            ...
            <div className="flex items-center gap-3">
               <div className="flex items-center gap-3 pl-3 border-l border-gray-200">
                  <div className="text-right hidden sm:block">
                    <p className="text-sm font-bold text-accent">{userRole === 'admin' ? 'Gestor' : 'Consultor'}</p>
                    <p className="text-[10px] font-bold text-secondary uppercase tracking-wider">TECNOLOC</p>
                  </div>
